...
export default function DzikirSore() {
    return (
        <>
            <Head title="Dzikir Sore" />
                                    ...
                                    <div className="max-w-3xl mx-auto">
                                        <article>
                                            ...
                                            <p className="mb-8">
                                                ...
                                                الله berkata: "Waktunya antara 'Ashar hingga
                                                terbenam matahari."
                                            </p>
